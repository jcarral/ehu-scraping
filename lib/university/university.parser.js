...
/**
 * Function to retrieve the the school name, school code,
 * campus code and degree name from text and url
...
const _getSchoolAndDegreeInfo = (text, href) => {
  ...
  else if (bracketsTxt.length === 4) {
    return { // If the text has 3 strings between brackets
      code: degreeCode,
