class EHUrls {
	...
	static getGrade(grade, school){
		if (!grade || !school)
			throw new Error('Error: Grade and school codes are required. [EHUrls.getGrade]');
		else
	...
	static getSubjectsPage(grade, school){
		if (!grade || !school)
			throw new Error('Error: Grade and school codes are required. [EHUrls.getSubjectsPage]');
		else
	...
	static getSubject(subject, school, grade, course){
		...
		else if (!grade) throw new Error('Error: Grade code is required. [EHUrls.getSubject]');
